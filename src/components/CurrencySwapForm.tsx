...
const currencyList: currencyItem[] = [
    ...
    { label: "STEVMOS", value: "STEVMOS", icon: <img src={BLUR} alt="STEVMOS" /> },
    ...
    { label: "ampLUNA", value: "ampLUNA", icon: <img src={ampLUNA} alt="ampLUNA" /> },
    ...
    { label: "axlUSDC", value: "axlUSDC", icon: <img src={axlUSDC} alt="axlUSDC" /> },
    ...
    { label: "YieldUSD", value: "YieldUSD", icon: <img src={YieldUSD} alt="YieldUSD" /> },
            ...
            >
                <form onSubmit={formik.handleSubmit}>
                    <Flex align="center" justify="center">
                        <Box pr="20px">
                            <h1 className="heading" align="center" pr="20px">Currency Converter</h1>
                        </Box>
                        ...
                        <Field.Root orientation="vertical">
                            ...
                            <Box width="100%">
                                <CustomSelect
                                    ...
                                    items={currencyList}
                                    size="md"
                                    onChange={(value) => formik.setFieldValue('currencyFrom', value)}
                                />
                            </Box>
                        </Field.Root>
